...
namespace Blackhat {
    ...
    public:
        ...
        virtual int getattr(std::string path) {throw std::runtime_error("getattr() is not implemented!");}; // the 'stat' command basically // TODO: set the return value properly
        virtual void readlink() {throw std::runtime_error("readlink() is not implemented!");}; // Read a symbolic link TODO: set the return value properly
        virtual std::vector<std::string> readdir(std::string path) {throw std::runtime_error("readdir() is not implemented!");};
        ...
        virtual int unlink(std::string path) {throw std::runtime_error("unlink() is not implemented!");}; // Remove a node
        virtual int rmdir(std::string path) {throw std::runtime_error("rmdir() is not implemented!");}; // Remove a (empty) directory
        virtual int symlink(std::string target, std::string linkpath) {throw std::runtime_error("symlink() is not implemented!");}; // Make a symbolic link
        virtual int rename(std::string oldpath, std::string newpath) {throw std::runtime_error("rename() is not implemented!");};
        virtual int link(std::string oldpath, std::string newpath) {throw std::runtime_error("link() is not implemented!");}; // Make a hardlink
        ...
        virtual std::string getxattr(std::string path, std::string name) {throw std::runtime_error("getxattr() is not implemented!");};
        virtual void listxattr(std::string path) {throw std::runtime_error("listxattr() is not implemented!");}; // TODO: Set the return value properly (either vector or map)
        virtual void removexattr(std::string path) {throw std::runtime_error("removexattr() is not implemented!");}; // TODO: Set return value properly
    };
}