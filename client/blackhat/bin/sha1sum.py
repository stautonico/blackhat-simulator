...
__DESCRIPTION__ = "compute and check SHA224 message digest"
__DESCRIPTION_LONG__ = "Print or check SHA224 (224-bit) checksums."
__VERSION__ = "1.2"
...
def main(args: list, pipe: bool) -> Result:
    ...
    if not args:
        ...
        for filename in args.files:
            ...
            hash = sha1(to_hash.encode()).hexdigest()
            if args.tag:
                output_text += f"SHA1 ({filename}) = {hash}\n"
            else:
